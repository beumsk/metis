 ...
 */
final class Version20221011133237 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contacts_information ADD CONSTRAINT FK_72B76A4785CFD64C FOREIGN KEY (cont_id) REFERENCES contacts (id)');
        $this->addSql('ALTER TABLE contacts_information ADD CONSTRAINT FK_72B76A47AAD3353B FOREIGN KEY (itel_id) REFERENCES patients_information_template_element (id)');
        $this->addSql('ALTER TABLE contacts_information ADD CONSTRAINT FK_72B76A47FE0F17F FOREIGN KEY (sugg_id) REFERENCES suggestions (id)');
