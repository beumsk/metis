 ...
 */
final class Version20221202124010 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patients_contacts ADD CONSTRAINT FK_EE6A61726B899279 FOREIGN KEY (patient_id) REFERENCES patients (id)');
