 ...
 */
final class Version20220926091824 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE medias CHANGE comment comment LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE medias CHANGE comment comment LONGTEXT DEFAULT NULL');
