 ...
 */
final class Version20221217154657 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patients ADD CONSTRAINT FK_2CCC2E2C9A42B392 FOREIGN KEY (fore_id) REFERENCES followup_reports (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
