 ...
 */
final class Version20221201191530 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patients_contacts ADD CONSTRAINT FK_EE6A617261D0310E FOREIGN KEY (pati_id) REFERENCES patients (id) ON DELETE SET NULL');
    }
